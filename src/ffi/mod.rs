...
// ==================== Format helpers (for synchronous one-shot socket ops) ====================
...
// ==================== Pairing code verification (moved from platform) ====================
...
// ==================== Dedup key (SHA-256 hex, moved from Android MessageSender) ====================
...
// ==================== Heartbeat timeout check (moved from platform) ====================
...
// ==================== Feature ID computation (moved from platform) ====================

/// Simplified feature ID based on package name and key text fields.
/// This replaces the platform-side SuperIslandProtocol.computeFeatureId logic.
#[no_mangle]
...
// ==================== Heartbeat JSON decode with callback (eliminates platform-side JSON re-parse) ====================

/// Parse a heartbeat line and call the structured callback directly,
/// so platform code does not need to re-parse JSON.
/// If cb is provided, calls cb(uuid, name, port, battery, device_type, user_data).
